...
- 偏好：简洁直接，喜欢幽默
- 时区：GMT+8
- **职业：江苏公务员考试和事业编考试线下培训机构负责人**

## 老板的机构（重要 - 永久记忆）
- **业务**：江苏公务员考试和事业编考试线下培训
- **需求**：提升机构运营效率 + 提升学生体验
- **关键对话记录**：
  - 2026-03-01：明确身份为公考培训机构负责人
  - 2026-03-01：要求记录所有关于机构发展的对话到永久记忆
  - 2026-03-01：开发edu-assistant技能，目标提升运营效率和学生体验
- **发展方向**：
  - 智能答疑（减少重复咨询）
  - 个性化学习规划（一人一策）
  - 学生进度跟踪（主动干预）
  ...
  - 模拟试题生成（精准练习）
  - 学习提醒（提升到课率）
- **技能文件**：~/.openclaw/workspace/skills/agent-best-practices/scripts/edu-assistant.mjs
...
4. 所有关于市场竞争的对话
5. 所有关于团队管理的对话
**记录位置**：MEMORY.md 或 memory/institution-development.md
